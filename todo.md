...
## 趋势图显示优化
- [x] 诊断当前SVG趋势图的显示问题
- [x] 选择更合适的图表实现方案（柱状图或优化的折线图）
- [x] 重新实现趋势图组件，确保坐标计算正确
- [x] 优化图表的视觉呈现（颜色、间距、标签）
- [x] 测试趋势图在不同数据量下的显示效果
- [x] 保存趋势图优化检查点

## 柱状图显示问题修复
- [x] 诊断柱子不显示的根本原因
- [x] 修改柱子高度计算方式（使用固定像素而非百分比）
- [x] 添加最小高度保证柱子可见性
- [x] 增强柱子的视觉对比度
- [x] 测试修复后的显示效果
- [x] 截图关键修改点
...
## ConsensusLab 品牌升级和专业表述优化
- [x] 设计ConsensusLab的品牌标识和核心价值主张
- [x] 优化系统标语和描述文案
- [x] 更新网站首页的系统名称和标语
- [x] 更新讨论创建页面的表述
- [ ] 更新讨论详情页面的表述
...
### P0 - 基础架构
- [x] 设计数据库schema
- [x] 创建数据库表（model_providers, models, user_api_keys等）
- [x] 实现模型适配器基类
- [x] 实现OpenAI适配器
- [x] 实现Claude适配器
- [x] 实现模型工厂类
